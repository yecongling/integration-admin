...
import EndpointRecycle from "./EndpointRecycle";
...
const Index: React.FC = () => {
  ...
  // 端点回收站弹窗
  const [openRecycle, setOpenRecycle] = useState<boolean>(false);
  ...
  return (
    <>
      ...
      />
      {/* 回收站弹窗 */}
      <EndpointRecycle open={openRecycle} onCancel={() => setOpenRecycle(false)}/>
    </>
  );
};
