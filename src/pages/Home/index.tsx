...
import { Avatar, Calendar, Card, Col, DatePicker, Flex, Row, Statistic } from "antd";
import "./index.less";
  ...
  return (
    <>
      <Row style={{ marginBottom: "8px" }}>
        <Col span={24}>
          <Card bordered={false} style={{ backgroundImage: `url(${titleBar})`, backgroundSize: 'cover' }} styles={{ body: { padding: '24px 40px' } }}>
            <Row>
              ...
              <Col span={6} style={{ color: '#fff' }}>
                <h1>下午好，欢迎登录</h1>
                <h4>一站式智能集成解决方案，帮助你高效与不同系统、不同协议进行相互对接</h4>
              </Col>
